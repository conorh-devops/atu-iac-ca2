...
function Network-Tests
{
 ...
 Process
 { 
     #TODO: I need to send the list of $computerNames to the next part of the process (Foreach).  #Which command should I use?
...
.PARAMETERS 
.Synopsis
 Main Function for checking open ports. 
.DESCRIPTION
 This function will check open ports given a computername and portlist.
.PARAMETERS
 $ComputerName: Pass a list of server names as String Array
 $PortList: Pass in a list of ports
#>
